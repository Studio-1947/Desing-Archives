export const ARCHIVE_ITEMS = [
  {
    ...
    description:
      "A deep dive into the traditional pottery techniques of Jagdish, preserving centuries-old methods of clay molding and firing.",
    fullStory:
  ...
  },
  {
    ...
    image:
      "https://images.unsplash.com/photo-1500462918059-b1a0cb512f1d?w=800&q=80", // Rural Landscape
    location: "Plassey",
    description:
      "Documenting the architectural innovations in Plassey, where local materials meet modern needs in sustainable housing.",
    fullStory:
  ...
  },
  {
    ...
    category: "Stories",
    image:
      "https://images.unsplash.com/photo-1596895111956-bf1cf0599ce5?w=800&q=80", // River/Boat
    location: "Sundarbans",
    description:
      "Life on the water: Capturing the oral histories and boat-building traditions of the Sundarbans delta.",
    fullStory:
  ...
  },
  {
    ...
    category: "Crafts",
    image:
      "https://images.unsplash.com/photo-1493106641515-6b5631de4bb9?w=800&q=80", // Pottery/Clay
    location: "Bishnupur",
    description:
      "Exploring the intricate terracotta temples of Bishnupur and the artisans who keep the restoration skills alive.",
    fullStory:
  ...
  },
  {
    ...
    category: "Crafts",
    image:
      "https://images.unsplash.com/photo-1606293926075-69a00dbfde81?w=800&q=80", // Textile/Fabric
    location: "Phulia",
    description:
      "The rhythm of the loom: A look at the handloom heritage of Phulia and its evolution in contemporary fashion.",
    fullStory:
  ...
  },
  {
    ...
    category: "Innovations",
    image:
      "https://images.unsplash.com/photo-1519181245277-cffeb31da2e3?w=800&q=80", // Bamboo/Structure
    location: "North East",
    description:
      "Sustainable engineering: How bamboo is being used to create earthquake-resistant structures in the North East.",
    fullStory:
